...
$output .= '<div class="header-wrapper agency-header">';
$output .= '<div id="sp-top-bar">';
    $output .= '<div class="container">';
        $output .= '<div class="container-inner">';
            $output .= '<div class="row">';

            $output .= '<div id="sp-top1" class="col-sm-6">';
            ...
            $output .= '<div id="sp-top2" class="col-sm-6">';
...
$output .= '<header id="sp-header">';
    $output .= '<div class="container">';
        $output .= '<div class="container-inner">';
            ...
            $class2 = 'col-4 col-lg-10';
            if($offcanvs_position == 'left')
            {
                $class1 = 'col-12 col-lg-2';
                $class2 = 'col-lg-10';
            }
                ...
                $output .= '<div id="sp-menu" class="d-none d-lg-block '. $class2 .'">';
                    $output .= '<div class="sp-column">';
