	...
	<div itemscope itemtype="http://schema.org/BreadCrumbList"
		...
		<?php if( count($list) > 0 ):?>
			<?php foreach ($list as $product_id => $product) : ?>
				...
				<!-- single product -->
				<div itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product" class="j2store j2store-single-product product-<?php echo $product->j2store_product_id; ?> j2store-module-product ">
