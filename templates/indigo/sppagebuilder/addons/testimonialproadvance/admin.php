...
SpAddonsConfig::addonConfig(
	array(
		'type'=>'repeatable',
		'addon_name'=>'sp_testimonialproadvance',
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_ADVANCE'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_ADVANCE_DESC'),
		'category'=>'Slider',
		'attr'=>array(
			'general' => array(
				...
				'slider_items'=>array(
					'type'=>'text',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SLIDER_ITEMS'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_TESTIMONIAL_PRO_SLIDER_ITEMS_DESC'),
					'std'=> 3,
				),
				...
				'controls'=>array(
					...
					'std'=>1,
					'depends'=>array(array('show_quote_aa', '=', 1)),
				),
