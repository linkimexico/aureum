				...
				<td valign="top" align="left" width="30%">
					<table class="table table-bordered">
						...
						if (!$response->was_successful()) {
							$app->enqueueMessage(JText::sprintf('RSFP_CAMPAIGNMONITOR_ERROR', $response->response->Code, $response->response->Message), 'warning');
						} else {
						?>
						...
						<tr class="campaignmonitor_fields">
							...
							else
							{
								...
								<?php
								$app->enqueueMessage(JText::_('RSFP_CAMPAIGNMONITOR_NOLIST'),'warning');
							} ?>
						</tr>
