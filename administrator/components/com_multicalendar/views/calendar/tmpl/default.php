...
<?php 
if (JC_JQUERY_UI_MV) {
	  echo "<script language='JavaScript' type='text/javascript' src='http".((!empty($_SERVER["HTTPS"]) && ($_SERVER["HTTPS"]!=="off"))?"s":"")."://code.jquery.com/ui/1.9.2/jquery-ui.min.js'></script>";
...
<script type="text/javascript">
	...
	+"</div>";
						  $(newRow).appendTo(".mesactual");
						   var mesactual="Inicio mes "+meses.nombre+" "+meses.elemento;
							
						$("div.cambio").html(mesactual);   
						  //  var textos="<span>Inicio mes "+meses.nombre+" "+meses.elemento+"</span>";
						   //$( textos ).appendTo( "div.cambio");
						    //$('div.cambio').append('Iniciomes');
				 		});	
