...
(function($) {
    ...
    $.fn.extend({
        ...
        defaults: {
            ...
            template:"<div class=\"simple-modal-header jsn_social\"> \
                <h1>{_TITLE_}</h1> \
            </div> \
                <div class=\"simple-modal-body jsn_social\"> \
                <div class=\"contents\" id=\"simple-modal-body\">{_CONTENTS_}</div> \
            </div> \
                <div class=\"simple-modal-footer jsn_social\"></div>"
        },
        ...
        showModal: function() {
            ...
            case "confirm":
                // Add button confirm
                this.addButton(this.options.btn_ok, "button button-action button-margin-right", function() {
                ...
                // Add button cancel
                this.addButton(this.options.btn_cancel, "button");
            case "modal":
				node = this._drawWindow(this.options);
                break;
            default:
				// Alert
                this.addButton(this.options.btn_ok, "button button-action");
				node = this._drawWindow(this.options);
            }           
