...
<div id="center">
	...
	<table class="jsnsocialTable footable" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><a href="<?php echo $this->request->base?>/topics/create/<?php echo $topic['Topic']['id']?>" target="_blank"><?php echo h($topic['Topic']['title'])?></a></td>
			<td><a href="<?php echo $this->request->base?>/admin/users/edit/<?php echo $topic['User']['id']?>"><?php echo h($topic['User']['name'])?></a></td>
			<td><?php echo $topic['Category']['name']?></td>
