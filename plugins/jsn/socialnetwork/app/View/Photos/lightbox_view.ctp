...
<div id="photo_wrapper" style="width:1260px;">
    <div id="tag-wrapper" style="height: 620px;width:933px;" class="tag_wrapper">
        <div style="display: table-cell; vertical-align: middle;position:relative">
            <img src="<?php echo $this->request->webroot?><?php echo $photo['Photo']['path']?>" class="showbox-img"> 
    ...
    <div id="lb_sidebar" style="height: 600px;width:307px;">
        <div style="overflow:hidden">
            <?php echo $this->Jsnsocial->getUserAvatar($photo['User'])?> 
            <div class="comment" style="line-height: 1.5">
            	<?php echo $this->Jsnsocial->getName($photo['User'])?><br />
            	<span class="date"><?php echo $this->Jsnsocial->getTime( $photo['Photo']['created'], $jsnsocial_setting['date_format'] )?></span><br />
            	<a href="<?php echo $this->request->base?>/reports/ajax_create/photo/<?php echo $photo['Photo']['id']?>" class="overlay" title="<?php echo __('Report')?>"><?php echo __('Report')?></a>
	            ...
	            <?php endif; ?>
	            &nbsp;<a href="javascript:void(0)" id="photo_like_count" onclick="likePhoto(<?php echo $photo['Photo']['id']?>, 1)" class="thumbUp <?php if ( !empty( $uid ) && !empty( $like['Like']['thumb_up'] ) ): ?>active<?php endif; ?>">&nbsp;</a> <span id="photo_like_count2"><?php echo $photo['Photo']['like_count']?></span>
                <a href="javascript:void(0)" id="photo_dislike_count" onclick="likePhoto(<?php echo $photo['Photo']['id']?>, 0)" class="thumbDown <?php if ( !empty( $uid ) && isset( $like['Like']['thumb_up'] ) && $like['Like']['thumb_up'] == 0 ): ?>active<?php endif; ?>">&nbsp;</a> <span id="photo_dislike_count2"><?php echo $photo['Photo']['dislike_count']?></span>
            </div> 
        </div>
