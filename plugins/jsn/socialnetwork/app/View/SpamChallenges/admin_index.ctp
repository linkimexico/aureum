...
<div id="center">	
	...
	<table class="jsnsocialTable" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td width="50px"><a href="javascript:void(0)" onclick="jsnsocialConfirm('Are you sure you want to delete this challenge?', '<?php echo $this->request->base?>/admin/spam_challenges/delete/<?php echo $challenge['SpamChallenge']['id']?>')"><i class="icon-trash icon-small"></i></a></td>
		</tr>
		<?php endforeach ?>
	</table>
</div>