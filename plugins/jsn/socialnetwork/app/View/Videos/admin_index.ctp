...
<div id="center">
	...
	<table class="jsnsocialTable footable" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><a href="<?php echo $this->request->base?>/videos/ajax_create/<?php echo $video['Video']['id']?>" class="overlay" title="<?php echo h($video['Video']['title'])?>"><?php echo h($video['Video']['title'])?></a></td>
			<td><a href="<?php echo $this->request->base?>/admin/users/edit/<?php echo $video['User']['id']?>"><?php echo h($video['User']['name'])?></a></td>
