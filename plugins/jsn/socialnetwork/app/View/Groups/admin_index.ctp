...
<div id="center">
	...
	<table class="jsnsocialTable footable" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><a href="<?php echo $this->request->base?>/groups/create/<?php echo $group['Group']['id']?>" target="_blank"><?php echo h($group['Group']['name'])?></a></td>
			<td><a href="<?php echo $this->request->base?>/admin/users/edit/<?php echo $group['User']['id']?>"><?php echo h($group['User']['name'])?></a></td>
