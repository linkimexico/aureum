...
<div id="center">
	...
	<table class="jsnsocialTable footable" cellpadding="0" cellspacing="0">
		...
		<tr id="<?php echo $field['ProfileField']['id']?>">
			...
			<td width="50px"><a href="javascript:void(0)" onclick="jsnsocialConfirm('Are you sure you want to delete this field? All the items within it will also be deleted. This cannot be undone!', '<?php echo $this->request->base?>/admin/profile_fields/delete/<?php echo $field['ProfileField']['id']?>')"><i class="icon-trash icon-small"></i></a></td>
		</tr>
		<?php endforeach ?>
		</tbody>
	</table>
