...
JsnApp::uses('ComponentCollection', 'Controller');
 ...
 */
class Controller extends JsnObject implements CakeEventListener {
	...
	public function render($view = null, $layout = null) {
		...
		foreach ($models as $currentModel) {
			...
			if ($currentObject instanceof Model) {
				...
				list($plugin) = pluginSplit(JsnApp::location($className));
 ...
 */
	protected function _getViewObject() {
		...
		if ($this->viewClass !== 'View') {
			...
			JsnApp::uses($viewClass, $plugin . 'View');
		}
