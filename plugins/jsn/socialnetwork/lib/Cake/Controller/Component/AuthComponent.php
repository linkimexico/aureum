...
JsnApp::uses('Security', 'Utility');
JsnApp::uses('Debugger', 'Utility');
JsnApp::uses('Hash', 'Utility');
JsnApp::uses('CakeSession', 'Model/Datasource');
JsnApp::uses('BaseAuthorize', 'Controller/Component/Auth');
JsnApp::uses('BaseAuthenticate', 'Controller/Component/Auth');
 ...
 */
	public function constructAuthorize() {
		...
		foreach ($config as $class => $settings) {
			...
			JsnApp::uses($className, $plugin . 'Controller/Component/Auth');
