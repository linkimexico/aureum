...
/* JSN - START */
spl_autoload_register(array('JsnApp', 'load'));
/* JSN - END */
JsnApp::uses('ErrorHandler', 'Error');
JsnApp::uses('Configure', 'Core');
JsnApp::uses('CakePlugin', 'Core');
JsnApp::uses('Cache', 'Cache');
JsnApp::uses('JsnObject', 'Core');
