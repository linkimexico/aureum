...
JsnApp::uses('TaskCollection', 'Console');
JsnApp::uses('ConsoleOutput', 'Console');
JsnApp::uses('ConsoleInput', 'Console');
JsnApp::uses('ConsoleInputSubcommand', 'Console');
JsnApp::uses('ConsoleOptionParser', 'Console');
JsnApp::uses('ClassRegistry', 'Utility');
JsnApp::uses('File', 'Utility');
JsnApp::uses('ClassRegistry', 'Utility');
 ...
 */
	protected function _checkUnitTest() {
		if (class_exists('PHPUnit_Framework_TestCase')) {
			...
			return true;
		} elseif (JsnApp::import('Vendor', 'phpunit', array('file' => 'PHPUnit' . DS . 'Autoload.php'))) {
			return true;
		}
 ...
 */
	protected function _pluginPath($pluginName) {
		...
		return current(JsnApp::path('plugins')) . $pluginName . DS;
	}
