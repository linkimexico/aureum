...
JsnApp::uses('TestShell', 'Console/Command');
JsnApp::uses('AppShell', 'Console/Command');
JsnApp::uses('CakeTestSuiteDispatcher', 'TestSuite');
JsnApp::uses('CakeTestSuiteCommand', 'TestSuite');
JsnApp::uses('CakeTestLoader', 'TestSuite');
