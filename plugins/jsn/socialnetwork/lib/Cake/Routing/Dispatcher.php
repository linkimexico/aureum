...
JsnApp::uses('CakeRequest', 'Network');
JsnApp::uses('CakeResponse', 'Network');
JsnApp::uses('Controller', 'Controller');
JsnApp::uses('Scaffold', 'Controller');
JsnApp::uses('View', 'View');
JsnApp::uses('Debugger', 'Utility');
	...
	protected function _attachFilters($manager) {
		...
		foreach ($filters as $index => $filter) {
			...
			if (is_string($filter['callable'])) {
				...
				JsnApp::uses($callable, $plugin . 'Routing/Filter');
 ...
 */
	protected function _loadController($request) {
		...
		if ($pluginPath . $controller) {
			...
			JsnApp::uses($pluginName . 'AppController', $pluginPath . 'Controller');
			JsnApp::uses($class, $pluginPath . 'Controller');
