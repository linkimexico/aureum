...
<div itemscope itemtype="https://schema.org/ItemList" class="j2store-product-list bs3"   data-link="<?php echo $active_link;?>">
					...
					?>
						...
						<?php //  if($product->enabled && $product->visibility):?>
							<?php $rowcount = ((int) $counter % (int) $col) + 1; ?>
								...
								<?php endif;?>
											<div itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem" class="col-sm-<?php echo round((12 / $col));?>">
