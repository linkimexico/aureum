...
$(function() {
      ...
      loadRepeatData = function(data)
      {
          ...
          var currentDate = strtodate(d[0]+i18n.dcmvcal.dateformat.separator+d[1]+i18n.dcmvcal.dateformat.separator+d[2]+" 00:00");
          $("#end_until_input").val(arrs.join(i18n.dcmvcal.dateformat.separator));
          if (data == "")
          ...
          for (var i=0;i<d.length;i++)
          {
              switch(d[i].k)
              {
                  ...
                  case "UNTIL":
                      ...
                      arrs = new Array();
                      arrs[i18n.dcmvcal.dateformat.year_index] = until.getFullYear();
                      arrs[i18n.dcmvcal.dateformat.month_index] = (until.getMonth()+1);
                      arrs[i18n.dcmvcal.dateformat.day_index] = until.getDate();
                      $("#end_until_input").val(arrs.join(i18n.dcmvcal.dateformat.separator));
                  break;
                  case "BYMONTHDAY":
                  case "BYMONTH":
          ...
          summaryDisplay = function()
          {
              ...
              else if ($("#end_until").is(":checked"))
              {
                  if ($("#end_until_input").val()!="")
                  {
                      ...
                      var endDate = strtodate(d[0]+i18n.dcmvcal.dateformat.separator+d[1]+i18n.dcmvcal.dateformat.separator+d[2]+" 23:59");
                      summary += ", "+i18n.dcmvcal.until+" " + monthsName[d[i18n.dcmvcal.dateformat.month_index]-1] + " " + d[i18n.dcmvcal.dateformat.day_index] + ", " + d[2];
          ...
          changeDisplay = function(v)
          {
              ...
              else
              {
                  ...
                  if (v==0)  $("#interval_label").html(i18n.dcmvcal.days);
